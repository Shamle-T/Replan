...
interface PlanViewProps { tasks: Task[]; schedule: ScheduledTask[]; dayStart: Date; dayEnd: Date; onSaveTask: (task: Task, placement?: ScheduledTask) => void; onRemoveTask: (taskId: string) => void; onFindTime: (taskId: string) => void; onOptimize: () => void; notice?: string; }
